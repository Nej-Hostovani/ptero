				  ...
				  <div class="row">
                      <div>
                        <div class="form-group col-md-4">
                            ...
                            <div>
                              <select class="form-control" name="widgetbot">
					...
					<div class="form-group col-md-4">
						...
						<div>
						  <input type="text" class="form-control" name="discordID" value="@isset($setting_data['discordID']){{$setting_data['discordID']}}@else   @endisset" />
                      ...
                      <div class="form-group col-md-4">
						<label class="control-label">Widgetbot Discord ID</label>
						<div>
                            <input type="text" class="form-control" name="channelID" value="@isset($setting_data['channelID']){{$setting_data['channelID']}}@else   @endisset" />
					  ...
					  <div class="form-group col-md-4">
						...
						<div>
						  <select class="form-control" name="enablearc">
                      ...
                      <div class="form-group col-md-4">
						...
						<div>
                            <input type="text" class="form-control" name="arcID" value="@isset($setting_data['arcID']){{$setting_data['arcID']}}@else  # @endisset" />
