				...
				<div class="box-body">
				  <div class="row">
					<div class="form-group col-md-4">
						...
						<div>
						  <input type="text" class="form-control" name="metatitle" value="@isset($setting_data['metatitle']){{$setting_data['metatitle']}}@else {{ config('app.name', 'Pterodactyl') }}  @endisset" />
						...
						<div class="form-group col-md-4">
						  ...
						  <div>
							<input type="text" class="form-control" name="metaimg" value="@isset($setting_data['metaimg']){{$setting_data['metaimg']}}@else https://cdn.resourcemc.net/zAsa7/rIBOyeRU58.png/raw @endisset" />
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div>
                              ...
                              @endisset class="form-control" name="metacolor" value="@isset($setting_data['metacolor']){{$setting_data['metacolor']}}@else @isset($setting_data['buttoncolor']){{$setting_data['buttoncolor']}}@else #0967d3 @endisset @endisset" />
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <div>
                                <textarea type="text" class="form-control" name="metadesc">@isset($setting_data['metadesc']){{$setting_data['metadesc']}}@else Manage your server with an easy-to-use Panel   @endisset</textarea>
