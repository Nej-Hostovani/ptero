                ...
                <div class="box-body">
                  <div class="row">
                    <div class="form-group col-md-4">
                      ...
                      <div>
                        <select class="form-control" name="alertenabled">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <div>
                        <input type="text" class="form-control" name="atitle" value="@isset($setting_data['atitle']){{$setting_data['atitle']}}@else Info @endisset" />
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <div>
                        ...
                        @endisset class="form-control" name="abackgroundcolor" value="@isset($setting_data['abackgroundcolor']){{$setting_data['abackgroundcolor']}}@else white @endisset" />
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <div>
                        <input @isset($setting_data['colorsel'])@if($setting_data['colorsel'] == 1) type="color" @else type="text"  @endif
                        @endisset class="form-control" name="alertcolor" value="@isset($setting_data['alertcolor']){{$setting_data['alertcolor']}}@else #4d90fd @endisset" />
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <div>
                        <textarea name="amessage" rows="3" class="form-control"> @isset($setting_data['amessage']){{$setting_data['amessage']}}@else  @endisset</textarea>
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <div>
                        <select class="form-control" name="alertclosable">
