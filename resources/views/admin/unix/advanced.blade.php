				  ...
				  <div class="row">
					...
					<div class="form-group col-md-4">
						...
						<div>
						  ...
						  @endisset class="form-control" name="sbactivecolor1" value="@isset($setting_data['sbactivecolor1']){{$setting_data['sbactivecolor1']}}@else #ff7551  @endisset" />
                      ...
                      <div class="form-group col-md-4">
						...
						<div>
						  <input @isset($setting_data['colorsel'])@if($setting_data['colorsel'] == 1) type="color" @else type="text"  @endif
						  @endisset class="form-control" name="sbactivecolor2" value="@isset($setting_data['sbactivecolor2']){{$setting_data['sbactivecolor2']}}@else #32a7e2  @endisset" />
                      ...
                      <div class="form-group col-md-4">
						...
						<div>
						  <input @isset($setting_data['colorsel'])@if($setting_data['colorsel'] == 1) type="color" @else type="text"  @endif
						  @endisset class="form-control" name="sbactivecolor3" value="@isset($setting_data['sbactivecolor3']){{$setting_data['sbactivecolor3']}}@else #6c5ecf  @endisset" />
						  <p class="text-muted"><small>This is the color of the third sidebar button.</small></p>
						</div>
					  </div>

                      <div class="form-group col-md-4">
						<label class="control-label">Sidebar & search background</label>
						<div>
						  <input @isset($setting_data['colorsel'])@if($setting_data['colorsel'] == 1) type="color" @else type="text"  @endif
						  @endisset class="form-control" name="sb-button-bg" value="@isset($setting_data['sb-button-bg']){{$setting_data['sb-button-bg']}}@else #353340  @endisset" />
						  <p class="text-muted"><small>This is the background color of the sidebar buttons and searchbar.</small></p>
						</div>
					  </div>
					  ...
					  <div class="form-group col-md-4">
						...
						<div>
						  <select class="form-control" name="sbsmalldevices">
